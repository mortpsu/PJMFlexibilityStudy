...
pGenData(GCC, 'Pmin') = pGenData(GCC, 'Pmax')*0.24;
...
pSUcost(GCC,SU) = pSUcost(GCC,'SU1')*0.75;
pSUcost(GCC,SU) = pSUcost(GCC,'SU2')*0.65;
pSUcost(GCC,SU) = pSUcost(GCC,'SU3')*0.55;
...
eSU3type(G,SU,N)$[Ord(SU) eq 3 and (Ord(N) + Int_Cond (G,'TD')) < pDownTime(G,SU) and GCGS(G)].. vSU_TYPE(G,SU,N) =l= 0;
...
execute_unload "results_psr.gdx" Z.L, vGenCost.L, vStartupCost.L, vReserveCost.L, vPenaltyCost.L, pGenCost, pGenSUCost, pFuelGen, pTechGen, vPower.l, vRS10.l, vRN10.l, vRS30.l, vRN30.l, vW.l , vU.l , vUP.l,vDown.l,vSU_TYPE.l,vNse.l,vOverGen.L,pShortRS10, pShortRP10, pShortRP30, pAVGcost,pPrice,pPriceRS10,pPriceRP10,pPriceRP30,vGenFuelCost.l,pVOMCost,pMIPGAP,pModelStat;
