...
*eInitalCond(G,N)$[ORD(N) <= (1+(TUR(G)+TDR(G))) and Int_Cond(G,'pU') = 1 and GCOMMIT(G)]..     vU(G,N) =e= Int_Cond(G,'pU');
...
display Z.L, vGenCost.L, vStartupCost.L, vReserveCost.L, vPenaltyCost.L, pGenCost, pGenSUCost, pFuelGen, pTechGen, vPower.l, vRS10.l, vRN10.l, vW.l , vU.l , vUP.l,vDown.l,vSU_TYPE.l,vNse.l,vOverGen.L,pShortRS10, pShortRP10, pAVGcost,pPrice,pPriceRS10,pPriceRP10,vGenFuelCost.l,pVOMCost,pMIPGAP,pModelStat,pTotalRS10,pTotalRN10,pTotalRP10;

execute_unload "results_base.gdx" Z.L, vGenCost.L, vStartupCost.L, vReserveCost.L, vPenaltyCost.L, pGenCost, pGenSUCost, pFuelGen, pTechGen, vPower.l, vRS10.l, vRN10.l, vW.l , vU.l , vUP.l,vDown.l,vSU_TYPE.l,vNse.l,vOverGen.L,pShortRS10, pShortRP10, pAVGcost,pPrice,pPriceRS10,pPriceRP10,vGenFuelCost.l,pVOMCost,pMIPGAP,pModelStat;

$ontext
**************************************
* Try Fixing Binary Variables and re-solving as RMIP to get better prices

vU.FX(G,N)  = vU.L(G,N);
vSU_TYPE.FX(G,SU,N) = vSU_TYPE.L(G,SU,N);
vBin.FX(GNGCC,N)   = vBin.L(GNGCC,N);

solve ERCOT using RMIP minimizing z ;


Parameter pPrice_RMIP(N);

pPrice_RMIP(N)$[ord(N) >1] = eDemand.m(N);
