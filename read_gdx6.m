...
results(i).RS30 = [results(i).RS30;vRS30(:,2:25)']  ; 
results(i).RN30 = [results(i).RN30;vRN30(:,2:25)']  ; 
...
results(i).PriceRP30 = [results(i).PriceRP30;pPriceRP30(2:25,:)];
...
results(i).RP30_SHORT=[results(i).RP30_SHORT;pShortRP30(2:25)'];
